...
//  arguments list defined in json
    const args_array = require("./rando_generate_custom.json");
...
//    prompts requester for unique identifier and exits with message to console and user if identifier exists
      ...
      let name_polling2 = shell.exec(`../../commands/commands/lsgrep.sh ${return_args[0]}`, {shell: '/bin/bash'}).stdout;
...
//      increment loop counter
      ...
      shell.exec(`${__dirname}/rando_generate_custom.sh `+return_string, {shell: '/bin/bash'}).stdout;
